...
export default function AdminProductList() {
  ...
  // handle filter category and brand
  const handleFilter = (e, section, option) => {
    ...
    // Update the filter based on whether the checkbox is checked or not
    if (isChecked) {
    ...
    setFilter(newFilter);
    dispatch(fetchProductsByFilters(newFilter));
  };
  ...
  const handlePage = (page) => {
    ...
    setPage(page);
    dispatch(fetchProductsByFilters(pagination));
  };
                  ...
                  <div className="lg:col-span-3">
                    <div>
                      <Link
                        ...
                        className="flex my-3 w-48 justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                      >
                        Add New Product
                      </Link>
                    </div>
                                ...
                                <Link to={`/product-detail/${product.id}`}>
                                  ...
                                  >
                                    ...
                                    <div className="mt-4 flex justify-between">
                                      ...
                                      <div>
                                        <p className="text-sm blcok font-medium text-gray-900">
                                          $
                                          {Math.round(
                                            product.price *
                                              (1 -
                                        ...
                                        <p className="text-sm blcok line-through font-medium text-gray-400">
                                          ${product.price}
                                        </p>
                                      </div>
                                    </div>
